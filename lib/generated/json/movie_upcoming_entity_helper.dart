...
movieUpcomingEntityFromJson(MovieUpcomingEntity data, Map<String, dynamic> json) {
	if (json['results'] != null) {
		data.results = new List<MovieUpcomingResult>();
		(json['results'] as List).forEach((v) {
			data.results.add(new MovieUpcomingResult().fromJson(v));
		});
	}
	if (json['page'] != null) {
	...
	if (json['dates'] != null) {
		data.dates = new MovieUpcomingDates().fromJson(json['dates']);
	}
...
Map<String, dynamic> movieUpcomingEntityToJson(MovieUpcomingEntity entity) {
...
movieUpcomingResultFromJson(MovieUpcomingResult data, Map<String, dynamic> json) {
...
Map<String, dynamic> movieUpcomingResultToJson(MovieUpcomingResult entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
movieUpcomingDatesFromJson(MovieUpcomingDates data, Map<String, dynamic> json) {
...
Map<String, dynamic> movieUpcomingDatesToJson(MovieUpcomingDates entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
