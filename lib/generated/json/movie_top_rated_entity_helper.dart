...
movieTopRatedEntityFromJson(MovieTopRatedEntity data, Map<String, dynamic> json) {
	if (json['page'] != null) {
	...
	if (json['results'] != null) {
		data.results = new List<MovieTopRatedResult>();
		(json['results'] as List).forEach((v) {
			data.results.add(new MovieTopRatedResult().fromJson(v));
		});
	}
	return data;
}

Map<String, dynamic> movieTopRatedEntityToJson(MovieTopRatedEntity entity) {
...
movieTopRatedResultFromJson(MovieTopRatedResult data, Map<String, dynamic> json) {
...
Map<String, dynamic> movieTopRatedResultToJson(MovieTopRatedResult entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
